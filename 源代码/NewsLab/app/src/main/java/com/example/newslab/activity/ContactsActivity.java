...
public class ContactsActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        newsPageButton.setOnClickListener(view -> {
            Intent toNewsIntent = new Intent(ContactsActivity.this, NewsActivity.class);
        ...
        messagePageButton.setOnClickListener(view -> {
            Intent toMessageIntent = new Intent(ContactsActivity.this, MessageActivity.class);
        ...
        minePageButton.setOnClickListener(view -> {
            Intent toMineIntent = new Intent(ContactsActivity.this, MineActivity.class);
